    ...
    <footer className='bg-black py-14'>
        <div className='max-w-6xl mx-auto  space-y-10  flex flex-col items-center text-white text-center'>
            <div className='space-y-5'>
                ...
                <p className='text-lg font-light text-gray-400'>I'm currently looking to join an energetic team who <br /> enjoys learning on the fly and working collaboratively.</p>
            </div>
            ...
            <p>© 2023 All rights reserved. – Designed & Coded by Ragavaraman</p>
        </div>
    </footer>
  )
}
